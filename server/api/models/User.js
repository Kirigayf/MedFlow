 ...
 * role:
 * type: string
 * enum: [admin, projectOwner, boardUser, moderator]  # ДОБАВЛЕНО moderator
...
const Roles = {
  ...
  MODERATOR: 'moderator', // <--- ДОБАВЛЕНА НОВАЯ РОЛЬ
};
...
module.exports = {
  ...
  attributes: {
    ...
    role: {
      type: 'string',
      isIn: Object.values(Roles), // Это поле автоматически подтянет 'moderator' из объекта Roles
      required: true,
    },
    name: {
      type: 'string',
